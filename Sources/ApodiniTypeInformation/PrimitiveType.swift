...
public enum ScalarType: String, RawRepresentable, CaseIterable, Hashable, Codable {
    /// Null
    case null
    /// Boolean
    case bool
...
public enum PrimitiveType: String, RawRepresentable, CaseIterable, TypeInformationElement {
    /// Null (NSNull)
    case null
    /// Bool
    case bool
