...
/// A wrapper around `Runtime.PropertyInfo` that provides additional `TypeInformation` auxiliary info
struct RuntimeProperty {
    ...
    /// Fluent property type if `mangledName` corresponds to the name of one of the fluent properties
    ...
    /// Initializes self out of a `Runtime.PropertyInfo`, by additionally creating the `typeInfo` of `propertyInfo.type`
